...
window.vidtop = {
    config_key: '2PACX-1vSXSzNQrPeKth2AbdlJhHm_-dbbpblVR6TUsX63BnkSsOAesQjsEuvvQYx-C9sdF4ePvW9LqIrAa4k8'
		...
		models.getData(_e2.gd_key, function(_e3){
			...
			_e3[_.map](function(_e4, _cb4){
				...
				if(_t111.src_type == 'youtube'){
				    ...
				    _t111.tileUrlExpanded = 'https://img.youtube.com/vi/' + _t111.src_play + '/hqdefault.jpg';
				}
				_cb4(null, _t111);
			    })
			}, function(_er, _ee4){
